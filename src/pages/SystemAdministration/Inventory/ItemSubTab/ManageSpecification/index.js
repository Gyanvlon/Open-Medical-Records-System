...
export default function ManageSpecification() {
  ...
  const isSpecificationDelete = useSelector(state => state.inventory.isSpecificationDelete)
  ...
  const handleDelete = (event) => {
   ...
   if(isSpecificationDelete){
    swal({
      title: "Thank You",
      text: "Specification Delete Successfully",
      icon: "success",
    })
   }else{
    swal({
  ...
  const handleCheckBox = (event) => {
    ...
    return (
      ...
      <ItemSubTab />
          <div mt={2}>
            <Card >
             <Box className={classes.headerText} >Manage Specification</Box>
             <Button variant="contained" color="primary"
                 className={classes.customBTN}
                 component={Link}
                 to="/app/system-administration/add_specification">
                 Add Specification
                </Button>
              <CardContent>
              ...
              <Box style={{ fontWeight: 'bold', textTransform: 'uppercase', marginLeft:15}} >List Specification </Box>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell component={Link}
                 to="/app/system-administration/update_specification" >test</TableCell>
