...
function AddSpecification() {
    ...
    const isSpecificationAdd = useSelector(state => state.inventory.isSpecificationAdd)
    ...
    return (
        ...
        <div mt={2}>
            <Card >
             <Box className={classes.headerText} >Add Specification</Box>
             <CardContent>
