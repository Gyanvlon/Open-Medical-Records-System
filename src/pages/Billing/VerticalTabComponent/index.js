        ...
        render={(history) => (
          <AppBar position="relative">
            ...
            >
              ...
              <Tab label="IPD Queue" />
              <Tab
                label="Billing Ambulance"
                value="/app/billing/billingambulancequeue"
                component={Link}
                to="/app/billing/billingambulancequeue"
              />
              <Tab 
              label="Billing Tender" 
              value="/app/billing/billingTenderqueue"
              component={Link}
              to="/app/billing/billingTenderqueue"
              />
              <Tab label="Billing Miscellaneous Service" />
              <Tab
                value="/app/billing/searchwalkingqueue"
                label="Search Patient System"
                component={Link}
                to="/app/billing/searchwalkingqueue"
              />
            </Tabs>
          </AppBar>
        )}
