...
function BillingAmbulance() {
    ...
    if (showListToOrder) {
        return <BillingListAmbulance popupListData={popupListData} />;
    } else {
        return (
            <>
                ...
                <div mt={2}>
                    <Typography variant="h5">List of Drivers</Typography>
...
export default BillingAmbulance