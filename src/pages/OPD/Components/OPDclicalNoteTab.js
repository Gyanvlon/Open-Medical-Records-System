...
function OPDclicalNoteTab({
    ...
    const [opdDashbord, setopdDashbord] = useState(false);
    const [vitalsVisited, setvitalsVisited] = useState(true);
    ...
    useEffect(() => {
        if (value === 0) setopdDashbord(!opdDashbord);
        if (value === 1){
            //  setShowVitalDialog(!showVitalDialog)
             setvitalsVisited(false)
            }
    }, [value])
    ...
    return (
        ...
        <div className={classes.root}>
            {!loadingPatient && patientObject ? (
                <>
                    {/* // OPD dashbord */}
                    {value === 0 && <PatientDashboard
                        patientData={patientObject}
                        selectedVisit={selectedVisit}
                        opdDashbord={opdDashbord}
                        setopdDashbord={setopdDashbord}
                    ></PatientDashboard>}
                    <Paper>
                        ...
                        <AppBar position="static">
                            <Tabs
                                ...
                                aria-label="Tabs"
                            >
                                <Tab label="OPD Dashbord" />
                                <Tab label="Vitals" />
                                <Tab label="Symptoms" disabled={vitalsVisited}  />
                                <Tab label="Diagnosis" disabled={vitalsVisited}  />
                                <Tab label="Procedure" disabled={vitalsVisited}  />
                                <Tab label="Investigation" disabled={vitalsVisited}  />
                                <Tab label="Medication" disabled={vitalsVisited}  />
                                <Tab label="Instructions & Visit outcome" disabled={vitalsVisited}  />
                            </Tabs>
                        </AppBar>
                        ...
                        <TabPanel value={value} index={1}>
                            ...
                            > */}
                                <DialogTitle id="vitalsDialogTitle">
                                    <h6 style={{ margin: 0 }}>Vital Signs</h6>
                ...
                <Paper >
                    <Box sx={{ display: 'flex', justifyContent: 'center', padding: 200 }}>
                        <CircularProgress />
                    </Box>
                </Paper>
            )}
...
export default connect(mapStateToProps, mapDispatchToProps)(OPDclicalNoteTab);
