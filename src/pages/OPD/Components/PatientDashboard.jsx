...
export default function PatientDashboard(props) {
  ...
  const handleClickOpen = () => {
    props.setopdDashbord(true);
  };

  const handleClose = () => {
    props.setopdDashbord(false);
  };
  ...
  return (
    <div>
      ...
      {/* <Button variant="outlined" color="primary" onClick={handleClickOpen} style={{ background: "#3EABC1", color: 'white' }}>
        Click Here To Open
      </Button> */}
      <Dialog
        fullScreen
        open={props.opdDashbord}
        onClose={handleClose}
