    ...
    <>
      ...
      <GridItem item xs={12} sm={6} md={4}>
        <Tooltip title="First Name of the person" arrow>
          <TextField
            ...
            onBlur={validateText}
            disabled ={formValues["Consent Agreement"]}
      ...
      <GridItem item xs={12} sm={6} md={4}>
        <TextField
          ...
          className={classes.field}
          fullWidth
          error={formErrors["Middle Name"] ? true : false}
          helperText={formErrors["Middle Name"]}
        />
      </GridItem>
      <GridItem item xs={12} sm={6} md={4}>
        <TextField
      ...
      {formValues["Consent Agreement"] && formValues["Health Number"] !== "" &&(
        <>
      ...
      <GridItem item xs={12} sm={6} md={4}>
        <TextField
          ...
          variant="outlined"
          label="ABHA Address"
          value={formValues["Health Id"]}
          onChange={onTextChange}
          disabled ={formValues["Consent Agreement"] && !formValues["Create Id"]} 
          onBlur={validateText}
          className={classes.field}
          fullWidth
          error={formValues["Consent Agreement"] && formErrors["Health Id"] ? true : false}
          helperText={formErrors["Health Id"]}
        />
      </GridItem>
        ...
        <TextField
          ...
          variant="outlined"
          label="ABHA Number"
          value={formValues["Health Number"]}
          onChange={onTextChange}
          onBlur={validateText}
          className={classes.field}
          disabled={true}
          fullWidth
          error={formErrors["Health Number"] ? true : false}
          helperText={formErrors["Health Number"]}
        />
      </GridItem>
      </>
      )}
